...
public class SchematicMask extends SchematicBlockBase {
    ...
    public void placeInWorld(IBuilderContext context, BlockPos pos, List<ItemStack> stacks) {
        if (isConcrete) {
            if (stacks.size() == 0 || !BuildCraftAPI.isSoftBlock(context.world(), pos)) {
                ...
                IBlockState state = itemBlock.field_150939_a.func_180642_a(context.world(), pos, solidFace, 0, 0, 0, stack.func_77960_j(), player);
    ...
    public void writeSchematicToNBT(NBTTagCompound nbt, MappingRegistry registry) {
        nbt.func_74757_a("isConcrete", isConcrete);
    }

    @Override
    public void readSchematicFromNBT(NBTTagCompound nbt, MappingRegistry registry) {
        isConcrete = nbt.func_74767_n("isConcrete");
    }
}
