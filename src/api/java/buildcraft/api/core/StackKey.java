...
public final class StackKey {
    ...
    public boolean equals(Object o) {
        ...
        if (stack != null) {
            if (stack.func_77973_b() != k.stack.func_77973_b() || stack.func_77981_g() && stack.func_77952_i() != k.stack.func_77952_i() || !objectsEqual(
                    stack.func_77978_p(), k.stack.func_77978_p())) {
                return false;
            }
        }
        if (fluidStack != null) {
    ...
    public int hashCode() {
        int result = 7;
        if (stack != null) {
            result = 31 * result + stack.func_77973_b().hashCode();
            result = 31 * result + stack.func_77952_i();
            result = 31 * result + objectHashCode(stack.func_77978_p());
        }
        result = 31 * result + 7;
        if (fluidStack != null) {
    ...
    public StackKey copy() {
        return new StackKey(stack != null ? stack.func_77946_l() : null, fluidStack != null ? fluidStack.copy() : null);
    }
}
