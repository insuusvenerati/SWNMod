...
public abstract class Schematic {
    ...
    public ItemStack useItem(IBuilderContext context, ItemStack req, IInvSlot slot) {
        ...
        if (stack.func_77984_f()) {
            if (req.func_77952_i() + stack.func_77952_i() <= stack.func_77958_k()) {
                stack.func_77964_b(req.func_77952_i() + stack.func_77952_i());
                result.func_77964_b(req.func_77952_i());
                req.field_77994_a = 0;
            }
            ...
            if (stack.field_77994_a >= req.field_77994_a) {
    ...
    public int getEnergyRequirement(List<ItemStack> stacksUsed) {
        ...
        if (stacksUsed != null) {
            for (ItemStack s : stacksUsed) {
                result += s.field_77994_a * BuilderAPI.BUILD_ENERGY;
            }
        }
