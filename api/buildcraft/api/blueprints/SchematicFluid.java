...
public class SchematicFluid extends SchematicBlock {
    ...
    public boolean isAlreadyBuilt(IBuilderContext context, BlockPos pos) {
        if (getLevel() == 0) {
            return state == context.world().func_180495_p(pos) && ((Integer) context.world().func_180495_p(pos).func_177229_b(BlockLiquid.field_176367_b)) == 0;
        } else {
            return state == context.world().func_180495_p(pos);
        }
    }
    ...
    public int getLevel() {
        return (Integer) state.func_177229_b(BlockLiquid.field_176367_b);
    }
}
