...
public class AIRobot {
    ...
    public final void writeToNBT(NBTTagCompound nbt) {
        nbt.func_74778_a("aiName", RobotManager.getAIRobotName(getClass()));
    ...
    public final void loadFromNBT(NBTTagCompound nbt) {
        loadSelfFromNBT(nbt.func_74775_l("data"));
        ...
        if (nbt.func_74764_b("delegateAI")) {
            ...
            try {
                Class<?> aiRobotClass;
                if (sub.func_74764_b("class")) {
                    // Migration support for 6.4.x
                    aiRobotClass = RobotManager.getAIRobotByLegacyClassName(sub.func_74779_i("class"));
                } else {
                    aiRobotClass = RobotManager.getAIRobotByName(sub.func_74779_i("aiName"));
                }
    ...
    public static AIRobot loadAI(NBTTagCompound nbt, EntityRobotBase robot) {
        ...
        try {
            ...
            if (nbt.func_74764_b("class")) {
                // Migration support for 6.4.x
                aiRobotClass = RobotManager.getAIRobotByLegacyClassName(nbt.func_74779_i("class"));
            } else {
                aiRobotClass = RobotManager.getAIRobotByName(nbt.func_74779_i("aiName"));
            }
            if (aiRobotClass != null) {
