...
public class ResourceIdBlock extends ResourceId {
    ...
    public void writeToNBT(NBTTagCompound nbt) {
        ...
        int[] arr = new int[] { pos.func_177958_n(), pos.func_177956_o(), pos.func_177952_p() };
        nbt.func_74783_a("pos", arr);

        nbt.func_74782_a("side", side.writeToNBT());
    }

    @Override
    protected void readFromNBT(NBTTagCompound nbt) {
        super.readFromNBT(nbt);
        int[] arr = nbt.func_74759_k("pos");
        pos = new BlockPos(arr[0], arr[1], arr[2]);

        side = EnumPipePart.readFromNBT(nbt.func_74781_a("side"));
    }
}
